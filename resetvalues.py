...
f = open('/root/dogecointicker/cryptsytrend.txt','w')
f.write(cryptsydata["return"]["markets"]["DOGE"]["lasttradeprice"])
f.close()
f = open('/root/dogecointicker/vircurextrend.txt','w')
f.write(vircurexdata["value"])
f.close()
f = open('/root/dogecointicker/coinsetrend.txt','w')
f.write(coinsedata["bid"])
f.close()
f = open('/root/dogecointicker/btertrend.txt','w')
f.write(bterdata["last"])
f.close()
f = open('/root/dogecointicker/mintpaltrend.txt','w')
